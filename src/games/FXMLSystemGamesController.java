...
/**
 * Classe responsável por definir todos atributos e metódos listar jogos. 
...
public class FXMLSystemGamesController implements Initializable {
    ...
    */
    @FXML private void loadSceneInsertGames() throws IOException {
        FXMLLoader fxmlloader = new FXMLLoader(getClass().getResource("/games/FXMLSystemInsertGame.fxml"));
    ...
    */
    ...
    /**
     * Função responsável por listar tipos de eventos de pesquisa.
     */
                    ...
                    else
                    {
                        ...
                        buttonUpdate.setOnAction(event -> {
                            ...
                            if(actionDelete.get() == ButtonType.OK){
                                ...
                                String result = repositoryOfGames.deleteDB();
                                if(!result.equals("DELETE")){
                                    alertInformation.setContentText("Jogo Utilizado");
                                    alertInformation.showAndWait();
                                }
    ...
    /**
    * Tela de Help de jogos.
    */
    @FXML private void help(){
        alertHelp.setTitle("AJUDA");
        alertHelp.setHeaderText(" ");
        alertHelp.setGraphic(new ImageView(("/images/information-help-games.jpg")));
        alertHelp.showAndWait();
    }
    
    /**
     *  Função que fornecer o status da games.
     */
    private void statusGames(){
        LocalDate localDate = LocalDate.now();
        Date date = Date.from(localDate.atStartOfDay(ZoneId.systemDefault()).toInstant());
        tableGames.setRowFactory(event -> {
            return new TableRow<Game>() {
                ...
                public void updateItem(Game item, boolean empty) {
                    ...
                    if (item == null) {
                        setStyle(null);
                    } else if (repositoryOfGames.checkGamesAllocated(Integer.toString(item.getCode())).equals("1")) {
