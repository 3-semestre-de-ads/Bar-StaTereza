...
/**
 * Classe responsável por definir todos os atributos e metódos listar reservas. 
...
public class FXMLSystemReservationsController implements Initializable {
    ...
    @FXML private void loadSceneInsertReservation() throws IOException {
        FXMLLoader fxmlloader = new FXMLLoader(getClass().getResource("/reservations/FXMLSystemInsertReservation.fxml"));
    ...
    */
    @FXML private void help(){
        ...
        alertHelp.setGraphic(new ImageView(("/images/information-help-reservations.jpg")));
    ...
    /**
     *  Função que fornecer o status da reserva.
     */
